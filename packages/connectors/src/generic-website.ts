...
export async function crawlWebsite(options:CrawlOptions,deps:FetchDependencies={}):Promise<ConnectorResult>{
  ...
  const robots=await safeFetch(robotsUrl,{...deps,maxBytes:200_000,...(options.timeoutMs!==undefined?{timeoutMs:options.timeoutMs}:{})}).catch(()=>undefined);
