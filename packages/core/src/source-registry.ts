...
export const CANONICAL_SOURCE_REGISTRY: Record<string, SourceDefinition> = {
  ...
  'vipemlak.az': {
    ...
    lastVerifiedAt: '2026-08-26T23:05:00.000Z',
    status: 'CANDIDATE',
    notes: 'Requires session CSRF token for dynamic phone reveal',
  },
  'ev10.az': {
    name: 'Ev10.az',
    domain: 'ev10.az',
    ...
    lastVerifiedAt: '2026-08-26T23:05:00.000Z',
    status: 'CANDIDATE',
    notes: 'React portal with client-rendered DOM',
  },
  'lalafo.az': {
    name: 'Lalafo.az',
    domain: 'lalafo.az',
    ...
    lastVerifiedAt: '2026-08-26T20:15:00.000Z',
    status: 'CANDIDATE',
    notes: 'General classifieds portal, requires candidate evaluation',
  },
  'unvan.az': {
    name: 'Unvan.az',
    domain: 'unvan.az',
