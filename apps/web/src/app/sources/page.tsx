      ...
      <div className="table-wrap"><table>
        ...
        <tbody>{rows.map((source) => {
          ...
          return <tr key={source.id}>
            <td>{source.name}{bina && <><br /><span className="muted">{t(lang, 'bina.automatic')} · {t(lang, 'bina.interval')}</span></>}</td>
            ...
            <td>
              ...
              {bina && run && <div className="muted">
                ...
                {t(lang, 'bina.nextRun')}: {formatDateTime(lang, nextBinaRunAt(run))}<br />
